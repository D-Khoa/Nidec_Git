...
using Com.Nidec.Mes.Common.Basic.MachineMaintenance.Cbm.PQMDataViewerCbm.PQMProductionControlCbm;

namespace Com.Nidec.Mes.Common.Basic.MachineMaintenance.Form
{
    public partial class PQMProductionControlForm : FormCommonNCVP
    {
        public PQMProductionControlForm()
        {
            InitializeComponent();
        }
        ...
        private void PQMProductionControlForm_Load(object sender, EventArgs e)
        {
        ...
        public string RatioRate(string code)
        {
            try
            {
                RateNGVo rate = (RateNGVo)DefaultCbmInvoker.Invoke(new GetPQMProductionRateNGRatioCbm(), new RateNGVo { RateModel = cmb_model.Text, RateLine = cmb_line.Text, RateCode = code }, connectionmes);
        ...
        void callModel()
        {
            ...
            ValueObjectList<PQMProductionControlVo> modelvolist = (ValueObjectList<PQMProductionControlVo>)DefaultCbmInvoker.Invoke(new GetPQMProductionModelCbm(), new PQMProductionControlVo(), connection);
        ...
        void callLine()
        {
            ValueObjectList<PQMProductionControlVo> assetvoinvoice = (ValueObjectList<PQMProductionControlVo>)DefaultCbmInvoker.Invoke(new GetPQMProductionLineCbm(), new PQMProductionControlVo { ModelCode = cmb_model.Text }, connection);
        ...
        private void cmb_process_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                ValueObjectList<PQMProductionControlVo> assetvoinvoice = (ValueObjectList<PQMProductionControlVo>)DefaultCbmInvoker.Invoke(new GetPQMProductionItemCbm(), new PQMProductionControlVo { ModelCode = cmb_model.Text, LineCode = cmb_line.Text, TableName = tablename, ProcessCode = cmb_process.Text }, connection);
        ...
        private string GridBindNG_NOICHK(bool t)
        {
            ...
            {
                tablename = cmb_model.Text + DateTime.Now.ToString("yyyyMM");
                ValueObjectList<PQMProductionControlVo> inspecdata = (ValueObjectList<PQMProductionControlVo>)DefaultCbmInvoker.Invoke(new SearchPQMNGNOICHKfromMesdbCbm(), new PQMProductionControlVo { ModelCode = cmb_model.Text, LineCode = cmb_line.Text, DateFrom = dtp_dateFromdata.Value, DateTo = dtp_dateTodata.Value, change = t }, connectionmes);
        ...
        private string GridBindQtyNOICHK(bool t)
        {
            try
            {
                ValueObjectList<PQMProductionControlVo> inspecdata = (ValueObjectList<PQMProductionControlVo>)DefaultCbmInvoker.Invoke(new SearchPQMQtyNOICHKfromMesdbCbm(), new PQMProductionControlVo { ModelCode = cmb_model.Text, LineCode = cmb_line.Text, DateFrom = dtp_dateFromdata.Value, DateTo = dtp_dateTodata.Value, change = t }, connectionmes);
                if (inspecdata.GetList()[0].InspecData != "")
                {
                    return inspecdata.GetList()[0].InspecData;
                }
        ...
        private void GridBind()
        {
            ...
            try
            {
                PQMProductionControlVo dgvVo = new PQMProductionControlVo()
                {
                    TableName = tablename,
                ...
                PQMProductionControlVo listvo = (PQMProductionControlVo)DefaultCbmInvoker.Invoke(new SearchPQMProductionINPUTCbm(), dgvVo, connection);

                PQMProductionControlVo outputvo = (PQMProductionControlVo)DefaultCbmInvoker.Invoke(new SearchPQMProductionOUTPUTCbm(), new PQMProductionControlVo()
                {
                    ModelCode = cmb_model.Text,
                    LineCode = cmb_line.Text,
                    DateFrom = DateTime.Parse(dtp_dateFromdata.Text),
                ...
                PQMProductionControlVo outputFinalvo = (PQMProductionControlVo)DefaultCbmInvoker.Invoke(new SearchPQMOUTPUTByHourCbm(), new PQMProductionControlVo()
                {
                    ModelCode = cmb_model.Text,
                    LineCode = cmb_line.Text,
                    DateFrom = DateTime.Parse(dtp_dateFromdata.Text),
                ...
                PQMProductionControlVo ngThurstVo = (PQMProductionControlVo)DefaultCbmInvoker.Invoke(new SearchPQMNGThurstChartCbm(), new PQMProductionControlVo()
                {
                    ModelCode = cmb_model.Text,
                    LineCode = cmb_line.Text,
                    DateFrom = DateTime.Parse(dtp_dateFromdata.Text),
                ...
                PQMProductionControlVo ngNOICHKVo = (PQMProductionControlVo)DefaultCbmInvoker.Invoke(new SearchPQMProductionNGNOICHKCbm(), new PQMProductionControlVo()
                {
                    ModelCode = cmb_model.Text,
                    LineCode = cmb_line.Text,
                    DateFrom = DateTime.Parse(dtp_dateFromdata.Text),
        ...
        private void GridBindProcess()
        {
            ...
            try
            {
                ...
                PQMProductionControlVo listvo = (PQMProductionControlVo)DefaultCbmInvoker.Invoke(new SearchPQMProductionProcessCbm(), dgvVo, connection);
        ...
        private string GridBindNew(string ProcessName_)
        {
            ...
            {
                tablename = cmb_model.Text + DateTime.Now.ToString("yyyyMM");
                ValueObjectList<PQMProductionControlVo> inspecdata = (ValueObjectList<PQMProductionControlVo>)DefaultCbmInvoker.Invoke(new SearchPQMProductionGA1Cbm(), new PQMProductionControlVo { ModelCode = cmb_model.Text, LineCode = cmb_line.Text, TableName = tablename, DateFrom = dtp_dateFromdata.Value, DateTo = dtp_dateTodata.Value, ProcessName = ProcessName_ }, connection);
                if (inspecdata.GetList()[0].InspecData != "")
                {
                    return inspecdata.GetList()[0].InspecData;
                }
        ...
        private void funtion()
        {
            try
            {
                ...
                tablename = cmb_model.Text + DateTime.Now.ToString("yyyyMM");
                ValueObjectList<PQMProductionControlVo> processVo = (ValueObjectList<PQMProductionControlVo>)DefaultCbmInvoker.Invoke(new SearchPQMProductionGA1Cbm(), new PQMProductionControlVo { ModelCode = cmb_model.Text, LineCode = cmb_line.Text, TableName = tablename, DateFrom = dtp_dateFromdata.Value, DateTo = dtp_dateTodata.Value, }, connection);
        ...
        private string OutputFinal(string Line)
        {
            try
            {
                ValueObjectList<PQMProductionControlVo> inspecdata = (ValueObjectList<PQMProductionControlVo>)DefaultCbmInvoker.Invoke(new SearchPQMOutputFinalCbm(), new PQMProductionControlVo
        ...
        private string GridBindOutputMotor(bool t)
        {
            ...
            {
                tablename = cmb_model.Text + DateTime.Now.ToString("yyyyMM");
                ValueObjectList<PQMProductionControlVo> inspecdata = (ValueObjectList<PQMProductionControlVo>)DefaultCbmInvoker.Invoke(new SearchPQMProductionoOutputMotorCbm(), new PQMProductionControlVo { ModelCode = cmb_model.Text, LineCode = cmb_line.Text, TableName = tablename, DateFrom = dtp_dateFromdata.Value, DateTo = dtp_dateTodata.Value, change = t }, connectionmes);
                if (inspecdata.GetList()[0].InspecData != "")
                {
                    return inspecdata.GetList()[0].InspecData;
                }
        ...
        private string GridBindNGThurst()//lay ng thúrst from mesdb
        {
            try
            {
                ValueObjectList<PQMProductionControlVo> inspecdata = (ValueObjectList<PQMProductionControlVo>)DefaultCbmInvoker.Invoke(new SearchPQMProductionNGThurstCbm(), new PQMProductionControlVo { ModelCode = cmb_model.Text, LineCode = cmb_line.Text, DateFrom = dtp_dateFromdata.Value, DateTo = dtp_dateTodata.Value }, connectionmes);
                if (inspecdata.GetList()[0].InspecData != "")
                {
                    return inspecdata.GetList()[0].InspecData;
                }
        ...
        private void cmb_line_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                tablename = cmb_model.Text + DateTime.Now.ToString("yyyyMM");
                ValueObjectList<PQMProductionControlVo> assetvoinvoice = (ValueObjectList<PQMProductionControlVo>)DefaultCbmInvoker.Invoke(new GetPQMProductionProcessCbm(), new PQMProductionControlVo { ModelCode = cmb_model.Text, LineCode = cmb_line.Text, TableName = tablename }, connection);
        ...
        private void GrindByProcess()
        {
            ...
            try
            {
                ...
                PQMProductionControlVo processvo = (PQMProductionControlVo)DefaultCbmInvoker.Invoke(new SearchPQMProductionProcessCbm(), dgvVo, connection);
        ...
        private void PQMProductionControlForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            timer1.Enabled = false;
            timerChart.Enabled = false;
        ...
        private void GrindExcel()
        {
            ...
            try
            {
                ...
                PQMProductionControlVo Exportvo = (PQMProductionControlVo)DefaultCbmInvoker.Invoke(new SearchPQMProductionExportDataCbm(), dgvVo, connection);

                ValueObjectList<PQMProductionControlVo> OutputExportvo = (ValueObjectList<PQMProductionControlVo>)DefaultCbmInvoker.Invoke(new SearchPQMProductionoOutputMotorCbm(), new PQMProductionControlVo
                {
                    change = true,
                    LineCode = cmb_line.Text,
                    DateFrom = DateTime.Parse(dtpFromExport.Text),
                ...
                ValueObjectList<PQMProductionControlVo> ThuchkExportvo = (ValueObjectList<PQMProductionControlVo>)DefaultCbmInvoker.Invoke(new SearchPQMProductionoOutputMotorCbm(), new PQMProductionControlVo
                {
                    change = false,
                    LineCode = cmb_line.Text,
                    DateFrom = DateTime.Parse(dtpFromExport.Text),
        ...
        private void btnRunMain_Click(object sender, EventArgs e)
        {
            try
            {
                chbMain.Text = "Online";
                ...
                for (int i = 0; i < cmb_line.Items.Count; i++)
                {
                    GridDGVMain(((PQMProductionControlVo)this.cmb_line.Items[i]).LineCode, DGV(((PQMProductionControlVo)this.cmb_line.Items[i]).LineCode));
                }
        ...
        public void GridDGVMain(string line, DataGridView dgvMain)
        {
            try
            {
                ...
                PQMProductionControlVo Exportvo = (PQMProductionControlVo)DefaultCbmInvoker.Invoke(new SearchPQMtabMainDGVCbm(), dgvVo, connection);
                dgvMain.DataSource = Exportvo.dt;

                ValueObjectList<PQMProductionControlVo> inspecdata = (ValueObjectList<PQMProductionControlVo>)DefaultCbmInvoker.Invoke(new SearchPQMOutputFinalCbm(), dgvVo, connectionmes);

                ValueObjectList<PQMProductionControlVo> inspectngThurst = (ValueObjectList<PQMProductionControlVo>)DefaultCbmInvoker.Invoke(new SearchPQMProductionNGThurstCbm(), dgvVo, connectionmes);

                ValueObjectList<PQMProductionControlVo> inspectngNoise = (ValueObjectList<PQMProductionControlVo>)DefaultCbmInvoker.Invoke(new SearchPQMNGNOICHKfromMesdbCbm(), new PQMProductionControlVo { ModelCode = cmb_model.Text, LineCode = line, DateFrom = dtp_FromMain.Value, DateTo = dtp_ToMain.Value, change = false }, connectionmes);
        ...
        private void btnStopMain_Click(object sender, EventArgs e)
        {
            timerMain.Enabled = false;
        }
        ...
        private void btnSearchChartMain_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < cmb_line.Items.Count; i++)
                {
                    ChartMain(((PQMProductionControlVo)this.cmb_line.Items[i]).LineCode, GridBindChartMain(((PQMProductionControlVo)this.cmb_line.Items[i]).LineCode));
                }
            }
            catch (Framework.ApplicationException exception)
            {
        ...
        public DataTable GridBindChartMain(string line)
        {
            ...
            try
            {
                ...
                PQMProductionControlVo vo = new PQMProductionControlVo
                {
                    ModelCode = cmb_model.Text,
                    LineCode = line,
                    DateFrom = DateTime.Parse(dtp_dateFromChartMain.Text),
                ...
                PQMProductionControlVo outputFinalvo = (PQMProductionControlVo)DefaultCbmInvoker.Invoke(new SearchPQMOUTPUTByHourCbm(), vo, connectionmes);

                PQMProductionControlVo ngThurstVo = (PQMProductionControlVo)DefaultCbmInvoker.Invoke(new SearchPQMNGThurstChartCbm(), vo, connectionmes);//lay ng thurst tu mesdb

                PQMProductionControlVo ngNOICHKVo = (PQMProductionControlVo)DefaultCbmInvoker.Invoke(new SearchPQMProductionNGNOICHKCbm(), vo, connectionmes);
